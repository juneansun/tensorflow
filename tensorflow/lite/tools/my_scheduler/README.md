...
[iOS benchmark app](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/my_scheduler/ios).
...
located
[here](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/my_scheduler/android).
...
[here](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/tools/my_scheduler/benchmark_model.cc)
and
[here](https://github.com/tensorflow/tensorflow/blob/master/tensorflow/lite/tools/my_scheduler/benchmark_tflite_model.cc)
...
bazel build -c opt \
  ...
  tensorflow/lite/tools/my_scheduler:benchmark_model
```
...
```
adb push bazel-bin/tensorflow/lite/tools/my_scheduler/benchmark_model /data/local/tmp
```
...
```
bazel build -c opt tensorflow/lite/tools/my_scheduler:benchmark_model
```
...
```
bazel-bin/tensorflow/lite/tools/my_scheduler/benchmark_model \
...
bazel build -c opt \
  --config=monolithic \
  tensorflow/lite/tools/my_scheduler:benchmark_model_plus_flex
```
...
```
bazel-bin/tensorflow/lite/tools/my_scheduler/benchmark_model_plus_flex \
