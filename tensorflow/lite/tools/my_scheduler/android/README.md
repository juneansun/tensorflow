...
[command-line benchmark utility](https://github.com/tensorflow/tensorflow/tree/master/tensorflow/lite/tools/my_scheduler).
...
bazel build -c opt \
  ...
  tensorflow/lite/tools/my_scheduler/android:benchmark_model
```
...
```
adb install -r -d -g bazel-bin/tensorflow/lite/tools/my_scheduler/android/benchmark_model.apk
```
